...
public class TMainParallel {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // ログ出力設定
        String pathOfLogDir = "logs" + File.separator + "tutorials" + File.separator + "sample08" + File.separator + "parallel"; // ログディレクトリ
        ...
        // シミュレーション基本情報
        simulationLogPW.println("sample08: Simulation of " + noOfHomes + " migrations. [parallel execution]");
        ...
        System.out.println("===========================================================================");
        System.out.println("sample08: Simulation of " + noOfHomes + " migrations. [parallel execution]");
